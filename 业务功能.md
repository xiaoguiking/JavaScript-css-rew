...
    useDocumentTitle('洛书 - 关系型数据库-XDB');
...
const ALL_OPTIONS = ['单机MySQL', 'DDBS'];
...
                        name="master"
                        label="主库"
                        description="公有云B区已上线,请选择bce后缀的机房"
                    >
                        <Select dataSource={idc} placeholder="机房
